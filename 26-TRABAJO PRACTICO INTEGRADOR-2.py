...
try:
    while 1<=cont<=6:
        if tipo_de_figura==1:
            ...
            print()
            lado = float(input("Ingrese la longitud del lado L1: "))
            perimetro = 4 * lado
            print()
        ...
        if tipo_de_figura==2:
            ...
            print()
            lado1 = float(input("Ingrese la longitud del lado L1: "))
            lado2 = float(input("Ingrese la longitud del lado L2: "))
        ...
        if tipo_de_figura==3:
            ...
            lado1 = float(input("Ingrese la longitud del lado L1: "))
            lado2 = float(input("Ingrese la longitud del lado L2: "))
            base = float(input("Ingrese la longitud de la lado L3: "))
            altura = float(input("Ingrese la longitud de la altura h: "))
        ...
        if tipo_de_figura==4:
            ...
            print()
            lado = float(input("Ingrese la longitud del lado L1: "))
            diagonal_mayor = float(input("Ingrese la longitud de la diagonal mayor Dm: "))
            diagonal_menor = float(input("Ingrese la longitud de la diagonal menor dm: "))
        ...
        if tipo_de_figura==5:
            ...
            print()
            lado1 = float(input("Ingrese la longitud del lado L1: "))
            lado2 = float(input("Ingrese la longitud del lado o base L2: "))
            altura = float(input("Ingrese la longitud de la altura h: "))
        ...
        if tipo_de_figura==6:
            ...
            lado1= float(input("Ingrese la longitud del lado L1: "))
            lado2 = float(input("Ingrese la longitud del lado L2: "))
            lado3 = float(input("Ingrese la longitud del lado L3: "))
            lado4 = float(input("Ingrese la longitud del lado L4: "))
            altura = float(input("Ingrese la longitud de la altura h: "))

            perimetro = lado1 + lado2 + lado3 + lado4
            print()
            print("El PERIMETRO del trapecio es:", perimetro, "[m]")
            area = (((lado2 + lado4)/2) * altura)
